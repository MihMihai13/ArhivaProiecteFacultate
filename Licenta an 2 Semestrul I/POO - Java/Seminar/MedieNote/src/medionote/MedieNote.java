...
public class MedieNote extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabelMEDIE, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, -1, -1));
        ...
        getContentPane().add(jLabelTITLU, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, -1, -1));

        jLabelNOTE.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabelNOTE.setText("INTRODU NOTE");
        getContentPane().add(jLabelNOTE, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, -1, 20));

        jLabelCALIFICATIV.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabelCALIFICATIV.setText("CALIFICATIV");
        getContentPane().add(jLabelCALIFICATIV, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 170, -1, -1));
        ...
        getContentPane().add(jRadioButtonCALIFICATIV, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, -1, -1));
        ...
        getContentPane().add(jTextFieldNOTE, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 80, 90, -1));
        ...
        getContentPane().add(jTextFieldMEDIE, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 90, -1));
        ...
        getContentPane().add(jButtonOK, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 40, 120, -1));
        ...
        getContentPane().add(jButtonMEDIE, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 80, 120, -1));
        ...
        getContentPane().add(jButtonRESET, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 120, 120, -1));
        ...
        getContentPane().add(jButtonEXIT, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 160, 120, -1));

        jListNOTE.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jScrollPane1.setViewportView(jListNOTE);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 40, 60, -1));
    ...
    private void jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOKActionPerformed
        ...
        if (num1 > 100) {
            JOptionPane.showMessageDialog(this, num1 + " nu epunctaj valid!!!");
        } else {
    ...
    private void jButtonRESETActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRESETActionPerformed
        ...
        number.clear();
        jListNOTE.setModel(number);
        //altfel retine numarNote si total de la toate calculele mediilor dinainte de
        //reset din sesiunea curenta
        numarNote = 0;
        total = 0;
    ...
    private void jButtonMEDIEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMEDIEActionPerformed
        ...
        jTextFieldNOTE.setEnabled(false);
        jButtonOK.setEnabled(false);
        //dupa ce am calculat media pana apas reset,
        //butonul medie devine inactiv
        jButtonMEDIE.setEnabled(false);
        jRadioButtonCALIFICATIV.setEnabled(true);
        ...
        if (medie >= 95)
            jLabelCALIFICATIV.setText("EXCELENT");
        else if (medie < 95 && medie >= 85)
            jLabelCALIFICATIV.setText("FOARTE BINE");
        else if (medie < 85 && medie >= 75)
            jLabelCALIFICATIV.setText("BINE");
        else if (medie < 75 && medie >= 60)
            jLabelCALIFICATIV.setText("SATISFACATOR");
        else if (medie < 60 && medie >= 45)
            jLabelCALIFICATIV.setText("SUFICIENT");
        else
            jLabelCALIFICATIV.setText("INSUFICIENT");
